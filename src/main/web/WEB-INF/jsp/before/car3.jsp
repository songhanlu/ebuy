            ...
            <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td style="padding:20px 0 30px 0; font-family:'宋体';">
                        银行名称 收款人信息：全称 ${sessionScope.cur_user.userName} ；收货地址：${userAddress.address}  ；。 <br />
                        <%--注意事项：办理电汇时，请在电汇单“汇款用途”一栏处注明您的订单号。--%>
                        <br/>
                        <span id="timeCountDown">5</span>秒后。。。跳转支付页面
                        <script type="text/javascript">
                            var sum = 5;
                            window.setInterval(function () {
                                ...
                                jq("#timeCountDown").text(sum);
                            }, 1000);
                            window.setTimeout(function () {
                                window.location.href = "${pageContext.request.contextPath}/car/toPay?p2_Order=${order.serialNumBer}&p3_Amt=${order.cost}";
                            }, 5000);
                        </script>
                ...
                <tr>
                    <td>
                        <a href="${pageContext.request.contextPath}/index/shl">首页</a> &nbsp; &nbsp; <a href="#">资讯中心</a>
                    </td>
                </tr>
            </table>
        </div>
