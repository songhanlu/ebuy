...
<div class="i_bg">
    <div class="content mar_20">
        <img src="${pageContext.request.contextPath}/statics/before_moban/images/img1.jpg" />
    </div>
        ...
        <table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
            ...
            <c:forEach items="${cars}" var="car">
                <tr class="car_tr" id="car-${car.carID}">
                    ...
                    <td align="center">
                        <div class="c_num">
                            <%--<input type="hidden" v-on:load="init()">--%>
                            <input type="button" value="" v-on:click="sub()" class="car_btn_1" />
                            <input type="text" v-model="number" name="" class="car_ipt" />
                            <input type="button" value="" v-on:click="add()" class="car_btn_2" />
                        </div>
                    </td>
                    <td align="center" style="color:#ff4e00;">￥ {{sum}}</td>
                    <td align="center"><a href="${pageContext.request.contextPath}/car/delCar?carID=${car.carID}&userID=${sessionScope.cur_user.id}">删除</a>&nbsp; &nbsp;<a href="#">加入收藏</a></td>
                </tr>
                <script>
                    new Vue({
                        el:"#car-${car.carID}",
                        data:{
                            number:${car.carProductQuatity},
                            price:${car.product.price},
                            sum:${car.product.price*car.carProductQuatity},
                        },
                        methods:{
                            sub: function () {
                                if(this.number>1){
                                ...
                                jq.post(
                                    "${pageContext.request.contextPath}/car/updateCar",
                                    {"carProductQuatity":this.number,
                                        "sum":this.sum,
                                        "carID":${car.carID},
                            ...
                            add: function () {
                                ...
                                jq.post(
                                    "${pageContext.request.contextPath}/car/updateCar",
                                    {"carProductQuatity":this.number,"sum":this.sum,"carID":${car.carID},"carUserID":${car.carUserID}},
                                    function (result) {
                                        jq("#sum").html(result.sum);
                                    }
                                );
            ...
            <tr height="70">
                <td colspan="6" style="font-family:'Microsoft YaHei'; border-bottom:0;">
                    ...
                    <span class="fr">商品总价：<b style="font-size:22px; color:#ff4e00;">￥<span id="sum">${sum}</span></b></span>
                </td>
            </tr>
            <tr valign="top" height="150">
                <td colspan="6" align="right">
                    <a href="${pageContext.request.contextPath}/index/shl">
                        <img src="${pageContext.request.contextPath}/statics/before_moban/images/buy1.gif" />
                    </a>&nbsp; &nbsp;
                    <a href="${pageContext.request.contextPath}/car/listCar2?userID=${sessionScope.cur_user.id}">
                        <img src="${pageContext.request.contextPath}/statics/before_moban/images/buy2.gif" />
                    </a>
                </td>
            </tr>
