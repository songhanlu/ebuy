...
<head>
    ...
    <jsp:include page="../after/head.jsp"/>
...
<div class="m_top_bg">
    <div class="top">
        <div class="m_logo">
            <a href="${pageContext.request.contextPath}/index/shl" style="font-size: 20px;color: white">返回首页</a></div>
        <div class="m_search">
            <form>
...
<div class="page-header" style="padding-top: 10px;">
    ...
    <div id="page-inner">
            <div class="row">
                <a class="navbar-brand"  href="${pageContext.request.contextPath}/index/shl"><strong>易买网资讯中心</strong></a>
            </div>
        <div class="row">
            <div>
                <h3 align="center" class="bg-success"><strong>新闻资讯</strong></h3>
            ...
            <div class="modal-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea class="form-control" rows="3" name="details" id="detailsDiv" readonly></textarea>
                        </td>
                    </tr>
...
<div class="i_bg bg_color">
    ...
    <div class="b_btm_bg b_btm_c">
        <div class="b_btm">
            <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="72"><img src="${pageContext.request.contextPath}/statics/before_moban/images/b1.png" width="62" height="62" /></td>
            ...
            <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="72"><img src="${pageContext.request.contextPath}/statics/before_moban/images/b2.png" width="62" height="62" /></td>
                    <td><h2>满38包邮</h2>满38包邮 免运费</td>
                </tr>
            </table>
            <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="72"><img src="${pageContext.request.contextPath}/statics/before_moban/images/b3.png" width="62" height="62" /></td>
                    <td><h2>天天低价</h2>天天低价 畅选无忧</td>
                </tr>
            </table>
            <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="72"><img src="${pageContext.request.contextPath}/statics/before_moban/images/b4.png" width="62" height="62" /></td>
    ...
    <div class="b_nav">
        ...
        <div class="b_er">
            <div class="b_er_c"><img src="${pageContext.request.contextPath}/statics/before_moban/images/er.gif" width="118" height="118" /></div>
            <img src="${pageContext.request.contextPath}/statics/before_moban/images/ss.png" />
        </div>
    </div>
    <div class="btmbg">
        <div class="btm">
...
<!--[if IE 6]>
<script src="${pageContext.request.contextPath}/statics/before_moban/js/zh_CN.js"></script>
<![endif]-->
</html>
