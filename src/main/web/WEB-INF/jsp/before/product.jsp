...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/statics/before_moban/css/ShopShow.css" />
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/statics/before_moban/css/MagicZoom.css" />
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/before_moban/js/MagicZoom.js"></script>

    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/before_moban/js/num.js">
        var jq = jQuery.noConflict();
    </script>

    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/before_moban/js/p_tab.js"></script>
...
<div class="i_bg">
    <div class="content">
        ...
        <div id="tsShopContainer">
            ...
            <img class="MagicZoomLoading" width="16" height="16" src="${pageContext.request.contextPath}/statics/upload/${product.fileName}" alt="" />
        </div>
        ...
        <div class="pro_des">
            ...
            <div class="des_join">
                <form id="addCar">
                <div class="j_nums">
                    <input type="text" value="1" name="carProductQuatity" class="n_ipt" />
                    ...
                    <input type="hidden" name="carUserID" value="${sessionScope.cur_user.id}">
                </div>
                <span class="fl">
                    <a onclick="addCarButton()">
                        <img src="${pageContext.request.contextPath}/statics/before_moban/images/j_car.png" />
                    </a>
                </span>
                </form>
            </div>
        ...
        <script type="text/javascript">
            function addCarButton() {
                var car = jq("#addCar").serialize();
                jq.post(
                    "${pageContext.request.contextPath}/car/addCar",
                    car
                );
    ...
    <div id="MyDiv" class="white_content">
        <div class="white_d">
            <div class="notice_t">
                <span class="fr" style="margin-top:10px; cursor:pointer;" onclick="CloseDiv('MyDiv','fade')"><img src="${pageContext.request.contextPath}/statics/before_moban/images/close.gif" /></span>
            </div>
            <div class="notice_c">

                <table border="0" align="center" style="margin-top:;" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                        <td width="40"><img src="${pageContext.request.contextPath}/statics/before_moban/images/suc.png"/></td>
                        <td>
    ...
    <div id="MyDiv1" class="white_content">
        <div class="white_d">
            <div class="notice_t">
                <span class="fr" style="margin-top:10px; cursor:pointer;" onclick="CloseDiv_1('MyDiv1','fade1')"><img src="${pageContext.request.contextPath}/statics/before_moban/images/close.gif" /></span>
            </div>
            <div class="notice_c">
                ...
                <table border="0" align="center" style="margin-top:;" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="50" valign="bottom">
                        <td>&nbsp;</td>
                        <td><a href="${pageContext.request.contextPath}/car/listCar?userID=${sessionScope.cur_user.id}" class="b_sure">去购物车结算</a><a href="#" class="b_buy" onclick="CloseDiv_1('MyDiv1','fade1')">继续购物</a></td>
                    </tr>
                </table>
...
<script src="${pageContext.request.contextPath}/statics/before_moban/js/ShopShow.js"></script>
